...
public class TimeSigSymbol : MusicSymbol {
    ...
    private static void LoadImages() {
        if (images == null) {
            ...
            images[2] = new Bitmap(typeof(TimeSigSymbol), "Resources.Images.two.png");
            images[3] = new Bitmap(typeof(TimeSigSymbol), "Resources.Images.three.png");
            images[4] = new Bitmap(typeof(TimeSigSymbol), "Resources.Images.four.png");
            images[6] = new Bitmap(typeof(TimeSigSymbol), "Resources.Images.six.png");
            images[8] = new Bitmap(typeof(TimeSigSymbol), "Resources.Images.eight.png");
            images[9] = new Bitmap(typeof(TimeSigSymbol), "Resources.Images.nine.png");
            images[12] = new Bitmap(typeof(TimeSigSymbol), "Resources.Images.twelve.png");
        }
    }
