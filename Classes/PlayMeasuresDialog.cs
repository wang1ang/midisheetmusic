...
public class PlayMeasuresDialog {
    ...
    public PlayMeasuresDialog(MidiFile midifile) {
        ...
        dialog = new Form();
        dialog.Text = Resources.Localization.Strings.playMeasuresTitle;
        ...
        enable.Text = Resources.Localization.Strings.playMeasuresTitle;
        ...
        label.Parent = dialog;
        label.Text = Resources.Localization.Strings.startMeasure;
        ...
        label = new Label();
        label.Parent = dialog;
        label.Text = Resources.Localization.Strings.endMeasure;
        label.Location = new Point(xpos, ypos);
        label.Size = new Size(labelheight * 3, labelheight);
